...
- 🚀 Passionate about building end-to-end products from concept to deployment  
- 🧩 Strong focus on maintainable code, clean APIs, and scalable systems  
...
- AI-powered product workflows with OpenAI API and local models  
- Cloud-native deployment and observability best practices  
